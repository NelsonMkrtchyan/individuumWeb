...
const dentistryPriceList = [
        ...
        subCategories: [
            {
                ...
                treatments: [
                    ...
                    {
                        name: "Pediatric endodontics and restoration with composite/standard crown",
                        price: "18000"
                    }
                ]
            }
        ...
        subCategories: [
            {
                ...
                treatments: [
                    ...
                    {
                        name: "Office whitening/Opalescence Boost/",
                        price: "40000"
                    },
                    {
    ...
    {
        id: 3,
        categoryName: "Endodontics / root canal treatment",
        color: "#ECBE21",
        logo: require("../Assets/Images/tooth_1.png"),
        subCategories: [
            {
        ...
        subCategories: [
            {
                ...
                treatments: [
                    ...
                    {
                        name: "Full porcelaine /e-max press/ inlay, onlay",
                        price: "70000"
                    },
                    {
                    ...
                    {
                        name: "Porcelaine veneer",
                        price: "105000 -120000"
                    },
                    {
                        name: "Porcelaine crown /e-max press/",
                        price: "105000 -120000"
                    },
                ]
            },
    ...
    {
        id: 7,
        categoryName: "Removable prosthesis",
        color: "#777FB0",
        logo: require("../Assets/Images/tooth_2.png"),
        subCategories: [
            {
...
const dentistryPriceListArmenian = [
    {
        id: 0,
        categoryName: "Թերապևտիկ ստոմատոլոգիա",
        color: "#ECBE21",
        ...
        subCategories: [
            {
                ...
                treatments: [
                    ...
                    {
                        name: "Մանկական էնդոդոնտիա և պսակի վերականգնում կոմպոզիտով/պսակով",
                        price: "18000"
                    }
                ]
            }
        ...
        subCategories: [
            {
                ...
                treatments: [
                    ...
                    {
                        name: "Օֆիսային սպիտակեցում /Opalescence Boost/",
                        price: "40000"
                    },
                    {
    ...
    {
        id: 3,
        categoryName: "Էնդոդոնտիա /արմատախողովակների բուժում/",
        color: "#ECBE21",
        logo: require("../Assets/Images/tooth_1.png"),
        subCategories: [
            {
        ...
        subCategories: [
            {
                ...
                treatments: [
                    ...
                    {
                        name: "Մետաղկերամիկական պսակ",
                        price: "50000"
                    },
                    {
                        name: "Ամբողջական ճենապակի /e-max press/ վերդիր, ներդիր",
                        price: "70000"
                    },
                    {
                        name: "Կերամիկական պսակ զիրկոնօքսիդի հիմքով",
                    ...
                    {
                        name: "Կերամիկական վինիր",
                        price: "105000 -120000"
                    },
                    {
                        name: "Կերամիկական պսակ /e-max press/",
                        price: "105000 -120000"
                    },
                ]
            },
    ...
    {
        id: 7,
        categoryName: "Շարժական պրոթեզավորում",
        color: "#777FB0",
        logo: require("../Assets/Images/tooth_2.png"),
        subCategories: [
            {
                ...
                treatments: [
                    ...
                    {
                        name: "Ռենտգեն հետազոտություն՝ OPG ",
                        price: "6000"
                    }
                ]
            }
...
export function getDentistryPriceList() {
    return dentistryPriceList;
}

export function getDentistryPriceListArmenian() {
    return dentistryPriceListArmenian;
}
