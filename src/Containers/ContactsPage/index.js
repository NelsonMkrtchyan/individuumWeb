          ...
          <div>
            ...
            <ul>
              <li className="contactsPageText">
                Armenia, Yerevan, 0026 Garegin Njdeh 44
              </li>
              <li className="contactsPageText">+374 10 44 84 21</li>
              <li className="contactsPageText">+374 96 44 84 21</li>
              <li className="contactsPageText">individuumclinic@gmail.com</li>
            </ul>
          </div>
          <div>
            <div className="contactsPageTitle">
            ...
            <ul>
              <li className="contactsPageText">Facebook</li>
              <li className="contactsPageText">Instagram</li>
              <li className="contactsPageText">Youtube</li>
            </ul>
          </div>
        </div>
